  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-surface">
      <div className="max-w-md w-full bg-surface-container-lowest p-8 rounded-2xl shadow-lg">
        <h2 className="text-2xl font-extrabold font-headline text-primary mb-6 text-center">Sign In</h2>
        ...
        <p className="text-center mt-6 text-sm text-on-surface-variant">
          Don't have an account? <a href="/signup" className="text-surface-tint font-bold hover:underline">Create one</a>
        </p>
      </div>
    </div>
  );
